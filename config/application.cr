...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amber Backend web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 6Q2b_K5G20qxtHMAgCvsFdjBMJFKM1jhjoetA6JbpeI
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("amber_backend.log", "w"))
  #
  #
end
